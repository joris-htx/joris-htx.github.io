      ...
      <Box component="section" sx={style.section}>
        ...
        <Stack direction="column" gap={1}>
          ...
          <IconItem
            ...
            text={<FormattedMessage id="PersonalInfo.Hobbies.Ski" defaultMessage="Skiing" />}
          />
          <IconItem
            icon={<CakeIcon />}
            text={<FormattedMessage id="PersonalInfo.Hobbies.Baking" defaultMessage="Baking" />}
          />
          <IconItem
            icon={<SpaIcon />}
            text={
              <FormattedMessage
                id="PersonalInfo.Hobbies.Plants"
                defaultMessage="Keeping exotic plants alive"
              />
            }
          />
        </Stack>
